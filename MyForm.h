...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->Name = L"MyForm";
			this->Text = L"Задача Дирихле для уравнения Пуассона. Безроднов";
...
#pragma endregion
	...
	private: System::Void button1_Click(System::Object^  sender, System::EventArgs^  e) {
			...
			double max = 0.0;  //  Норма бесконечная
			double sum = 0.0;  //  Норма суммы
		...
		System::Windows::Forms::MessageBox::Show(
			...
			+ "\nЧисло выполненных итераций метода = " + Convert::ToString(Step) + "\n\nТочность на выходе = " + Convert::ToString(eps_max)
			+"\nпри заданной точности метода " + Convert::ToString(eps)
			 + "\n\nНевязка на выходе = " + Convert::ToString(R) +
			// максимум модуля разности точного и численного решения
			"\n\nЗадача решена с погрешностью " + Convert::ToString(max),
			"Выходные данные",
